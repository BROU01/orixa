...
const DEFAULT_PRODUCTS: Product[] = [
  ...
  { id: 'exo-akpi', nom: 'Akpi (附件籽)', slug: 'akpi', prix: 5.90, img: '/products/exotic/Akpi.jpg', cat: 'exotic', unite: 'Sac 200 g', origine: 'Côte d\'Ivoire', stock: 25, badge: 'Nouveau', description: 'Graines d\'akpi pour sauces et condiments. Saveur unique et texturingante.', labelImg: '/products/exotic/Akpi etiquette.jpeg' },
...
const DEFAULT_MEDIA: Media[] = [
  ...
  { src: '/products/cosmetics/Kojic Acid Essential Oils For Skin Brightening & Hydrating Body Oil For Women.jpg', name: 'Kojic Acid Body Oil.jpg', builtin: true },
  ...
  { src: '/products/cosmetics/Vaseline Intensive Care Vitamin B3 Body Oil is a lightweight, fast-absorbing body oil enriched with Vitamin B3 (Niacinamide) and nourishing skin oils that deeply moisturize and revitalize dry, dull skin_ Its non-.jpg', name: 'Vaseline Vitamin B3 Body Oil.jpg', builtin: true },
